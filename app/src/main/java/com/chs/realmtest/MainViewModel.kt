...
class MainViewModel : ViewModel() {
    private val realm = RealmTestApp.realm
        ...
        viewModelScope.launch {
            realm.write {
                ...
                val course1 = Course().apply {
                    name = "Kotlin Programming Mead Easy"
                }
                ...
                val student1 = Student().apply {
                    name = "Cha Seock Junior"
                }

                val student2 = Student().apply {
                    name = "Hyeon Seock Junior"
                }
    ...
    fun deleteCourse() {
        viewModelScope.launch {
            realm.write {
                ...
                val lateCourse = findLatest(course) ?: return@write
                delete(lateCourse)
